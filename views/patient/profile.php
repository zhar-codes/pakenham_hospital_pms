  ...
  <section class="col-lg-9">
    ...
    <div class="card mb-4">
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between mb-2">
          ...
          <a class="btn btn-outline-secondary btn-sm" href="<?= $routePatient ?>/profile_edit.php">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form class="row g-3" action="<?= $routePatient ?>/password_save.php" method="post" novalidate>
          <div class="col-md-6">
          ...
          <div class="col-12 d-flex gap-2">
            ...
            <a class="btn btn-outline-secondary" href="<?= $routePatient ?>/profile.php">Cancel</a>
          </div>
        </form>
      </div>
    </div>
